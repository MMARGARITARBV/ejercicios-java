...
public class escalera {
    ...
    int numEscalonesIntroducidos = Integer.parseInt(System.console().readLine());
    ...
    System.out.println("\nIntroduciendo altura y numero de escalones: \n");
      ...
      for(int z = 0; z < numEscalonesIntroducidos; z++){ //  sin tener en cuenta la altura del escalón
      ...
      for(int escalon = 0; escalon < numEscalonesIntroducidos; escalon++){ // teniendo en cuenta la altura y  el numero de escalones
        for (int y = 0 ; y < alturaEscalon ; y++){
          for (int x = 0; x < 4 + numEscalonesIntroducidos * escalon ; x++) {
            System.out.print("*");
          }
      ...
      for(int z = 0; z < numEscalonesIntroducidos; z ++){  // introduciendo todos los datos  
      for(int y = 0 ; y < alturaEscalon; y++){
